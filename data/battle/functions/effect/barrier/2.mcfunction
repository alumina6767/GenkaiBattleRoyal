...
playsound item.shield.block player @a ~ ~ ~ 1.0 2.0 0.0
...
## 発射主の近くでも鳴らす
execute as @a[tag=owner] at @s run playsound block.anvil.place player @s ~ ~ ~ 1.0 2.0 0.0
execute as @a[tag=owner] at @s run playsound item.shield.block player @s ~ ~ ~ 1.0 2.0 0.0
