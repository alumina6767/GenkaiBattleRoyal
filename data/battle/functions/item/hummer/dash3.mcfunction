...
scoreboard players operation _ mx *= @s hummer.speed
scoreboard players operation _ mz *= @s hummer.speed
...
scoreboard players operation delta_rx _ *= @s hummer.speed
scoreboard players operation delta_rx _ *= @s hummer.speed
...
## 加速分を増加
scoreboard players add @s hummer.speed 10
