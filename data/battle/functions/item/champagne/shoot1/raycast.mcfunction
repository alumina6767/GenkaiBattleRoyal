...
## エンティティの探索
execute positioned ~-0.25 ~-0.25 ~-0.25 as @e[dx=0] positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[predicate=battle:can_take_damage,dx=0] run function battle:item/champagne/found_entity
