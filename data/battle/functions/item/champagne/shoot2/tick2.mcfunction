#> battle:item/champagne/shoot2/tick2
# as bullet
# @internal
...
## 探索の回数を指定
scoreboard players set .itt raycast 11

## 衝突の探索
function battle:item/champagne/shoot2/raycast

## 壁に当たった時
execute if score .itt raycast matches 0 run scoreboard players set @s champagne.time 0

## エンティティに当たった時
execute if score .itt raycast matches -1 run function battle:item/champagne/shoot2/hit_entity

## 壁もエンティティもなかった時
execute if score .itt raycast matches 1 run tp ^ ^ ^2.5
