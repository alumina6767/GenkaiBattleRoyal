...
## エンティティの探索
execute positioned ~-0.2 ~-0.2 ~-0.2 as @e[dx=0] positioned ~-0.4 ~-0.4 ~-0.4 if entity @s[predicate=battle:can_take_damage,dx=0] run function battle:item/champagne/found_entity
