...
## 弾を召喚
execute if entity @s[tag=!battle.boss] run summon armor_stand ~ ~ ~ {Tags:["champagne.bullet_normal","new","champagne.bullet.first","barrier.blockable"],Small:1b,Marker:1b,Invisible:1b,Silent:1b,CustomName:'{"text":"invisible"}'}
execute if entity @s[tag=battle.boss] run summon armor_stand ~ ~ ~ {Silent:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["champagne.bullet_normal","new","champagne.bullet.first"],CustomName:'{"text":"invisible"}'}
