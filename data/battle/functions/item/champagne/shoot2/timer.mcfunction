...
## 発射
# execute if score _ _ matches 0 at @s anchored eyes positioned ^ ^ ^ run function battle:item/champagne/shoot2/shoot
execute at @s anchored eyes positioned ^ ^ ^ run function battle:item/champagne/shoot2/shoot
