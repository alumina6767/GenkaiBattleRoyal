#> battle:item/bits/5000to10000/
# 1000から5000へ
# @internal

#>
# @within battle:item/bits/5000to10000/**
...
## 繰り上げて個数を代入
loot replace entity @s weapon.mainhand loot battle:bits/10000
item modify entity @s weapon.mainhand share:score2count

## 端数の個数を取得
scoreboard players operation count tmp %= 2 const
...
## 進捗のリセット
advancement revoke @s only battle:bits/5000to10000