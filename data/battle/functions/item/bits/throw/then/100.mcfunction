...
## 飛ばすファイアーボール
summon fireball ^ ^ ^2.0 {ExplosionPower:0b,Tags:["new","100bits","bits"],Passengers:[{id:"minecraft:area_effect_cloud",Radius:0f,Duration:10000,Tags:["100bits","bits","new"]}],Item:{id:"minecraft:ender_eye",tag:{CustomModelData:670000},Count:1b}}
...
## ダメージ情報を保存
scoreboard players set @e[type=fireball,tag=new,limit=1] battle.hurt_with 670000
