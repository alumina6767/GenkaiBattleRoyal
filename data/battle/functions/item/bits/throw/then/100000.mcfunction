...
## 飛ばすファイアーボール
summon fireball ^ ^ ^0.1 {ExplosionPower:7b,Tags:["new","100000bits","bits"],Passengers:[{id:"minecraft:area_effect_cloud",Radius:0f,Duration:10000,Tags:["100000bits","bits"]}],Item:{id:"minecraft:ender_eye",tag:{CustomModelData:670004},Count:1b}}
