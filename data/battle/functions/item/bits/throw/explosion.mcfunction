...
## クリーパーの召喚
summon creeper ~ 200 ~ {Fire:1,NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Fuse:3,ignited:1b,Tags:["new"],ActiveEffects:[{Id:14,Amplifier:1b,Duration:1,ShowParticles:0b}]}
