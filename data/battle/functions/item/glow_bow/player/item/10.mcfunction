#> battle:item/glow_bow/player/item/10
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:10b}].tag.ammo
...
item modify entity @s inventory.1 battle:item/glow_bow/ammo
