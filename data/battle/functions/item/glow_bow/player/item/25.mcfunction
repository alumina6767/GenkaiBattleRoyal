#> battle:item/glow_bow/player/item/25
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:25b}].tag.ammo
...
item modify entity @s inventory.16 battle:item/glow_bow/ammo
