#> battle:item/glow_bow/player/item/4
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:4b}].tag.ammo
...
item modify entity @s hotbar.4 battle:item/glow_bow/ammo
