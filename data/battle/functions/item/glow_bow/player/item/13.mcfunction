#> battle:item/glow_bow/player/item/13
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:13b}].tag.ammo
...
item modify entity @s inventory.4 battle:item/glow_bow/ammo
