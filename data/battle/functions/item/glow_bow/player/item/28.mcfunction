#> battle:item/glow_bow/player/item/28
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:28b}].tag.ammo
...
item modify entity @s inventory.19 battle:item/glow_bow/ammo
