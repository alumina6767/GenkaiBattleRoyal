#> battle:item/glow_bow/player/item/7
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:7b}].tag.ammo
...
item modify entity @s hotbar.7 battle:item/glow_bow/ammo
