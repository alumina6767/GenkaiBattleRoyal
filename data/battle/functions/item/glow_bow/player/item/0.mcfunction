#> battle:item/glow_bow/player/item/0
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:0b}].tag.ammo
...
item modify entity @s hotbar.0 battle:item/glow_bow/ammo
