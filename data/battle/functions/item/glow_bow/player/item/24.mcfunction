#> battle:item/glow_bow/player/item/24
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:24b}].tag.ammo
...
item modify entity @s inventory.15 battle:item/glow_bow/ammo
