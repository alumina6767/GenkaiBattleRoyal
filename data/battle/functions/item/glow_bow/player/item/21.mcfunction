#> battle:item/glow_bow/player/item/21
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:21b}].tag.ammo
...
item modify entity @s inventory.12 battle:item/glow_bow/ammo
