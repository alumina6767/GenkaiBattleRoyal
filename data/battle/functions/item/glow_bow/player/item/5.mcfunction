#> battle:item/glow_bow/player/item/5
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:5b}].tag.ammo
...
item modify entity @s hotbar.5 battle:item/glow_bow/ammo
