#> battle:item/glow_bow/player/item/6
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:6b}].tag.ammo
...
item modify entity @s hotbar.6 battle:item/glow_bow/ammo
