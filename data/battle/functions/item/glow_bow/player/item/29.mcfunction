#> battle:item/glow_bow/player/item/29
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:29b}].tag.ammo
...
item modify entity @s inventory.20 battle:item/glow_bow/ammo
