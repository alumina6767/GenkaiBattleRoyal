#> battle:item/glow_bow/player/item/11
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:11b}].tag.ammo
...
item modify entity @s inventory.2 battle:item/glow_bow/ammo
