#> battle:item/glow_bow/player/item/19
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:19b}].tag.ammo
...
item modify entity @s inventory.10 battle:item/glow_bow/ammo
