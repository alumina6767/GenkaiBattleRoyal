#> battle:item/glow_bow/player/item/33
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:33b}].tag.ammo
...
item modify entity @s inventory.24 battle:item/glow_bow/ammo
