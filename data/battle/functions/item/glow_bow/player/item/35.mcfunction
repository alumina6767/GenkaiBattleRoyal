#> battle:item/glow_bow/player/item/35
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:35b}].tag.ammo
...
item modify entity @s inventory.26 battle:item/glow_bow/ammo
