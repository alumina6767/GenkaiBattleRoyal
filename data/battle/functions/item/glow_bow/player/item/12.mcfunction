#> battle:item/glow_bow/player/item/12
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:12b}].tag.ammo
...
item modify entity @s inventory.3 battle:item/glow_bow/ammo
