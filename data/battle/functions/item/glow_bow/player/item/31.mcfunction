#> battle:item/glow_bow/player/item/31
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:31b}].tag.ammo
...
item modify entity @s inventory.22 battle:item/glow_bow/ammo
