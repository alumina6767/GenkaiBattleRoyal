#> battle:item/glow_bow/player/item/20
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:20b}].tag.ammo
...
item modify entity @s inventory.11 battle:item/glow_bow/ammo
