#> battle:item/glow_bow/player/item/18
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:18b}].tag.ammo
...
item modify entity @s inventory.9 battle:item/glow_bow/ammo
