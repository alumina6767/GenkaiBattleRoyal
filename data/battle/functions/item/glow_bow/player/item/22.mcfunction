#> battle:item/glow_bow/player/item/22
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:22b}].tag.ammo
...
item modify entity @s inventory.13 battle:item/glow_bow/ammo
