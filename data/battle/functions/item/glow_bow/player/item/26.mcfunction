#> battle:item/glow_bow/player/item/26
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:26b}].tag.ammo
...
item modify entity @s inventory.17 battle:item/glow_bow/ammo
