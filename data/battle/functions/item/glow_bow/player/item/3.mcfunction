#> battle:item/glow_bow/player/item/3
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:3b}].tag.ammo
...
item modify entity @s hotbar.3 battle:item/glow_bow/ammo
