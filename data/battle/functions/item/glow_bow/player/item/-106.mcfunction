#> battle:item/glow_bow/player/item/-106
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:-106b}].tag.ammo
...
item modify entity @s weapon.offhand battle:item/glow_bow/ammo
