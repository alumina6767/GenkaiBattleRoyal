#> battle:item/glow_bow/player/item/2
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:2b}].tag.ammo
...
item modify entity @s hotbar.2 battle:item/glow_bow/ammo
