#> battle:item/glow_bow/player/item/1
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:1b}].tag.ammo
...
item modify entity @s hotbar.1 battle:item/glow_bow/ammo
