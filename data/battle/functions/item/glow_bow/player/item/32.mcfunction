#> battle:item/glow_bow/player/item/32
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:32b}].tag.ammo
...
item modify entity @s inventory.23 battle:item/glow_bow/ammo
