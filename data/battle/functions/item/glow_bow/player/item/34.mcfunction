#> battle:item/glow_bow/player/item/34
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:34b}].tag.ammo
...
item modify entity @s inventory.25 battle:item/glow_bow/ammo
