#> battle:item/glow_bow/player/item/8
#> 
execute store result score _ _ run data get entity @s Inventory[{Slot:8b}].tag.ammo
...
item modify entity @s hotbar.8 battle:item/glow_bow/ammo
