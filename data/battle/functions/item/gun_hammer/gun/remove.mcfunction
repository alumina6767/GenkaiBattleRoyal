...
loot replace entity @s weapon.mainhand loot battle:item/gun_hammer/gun
item modify entity @s weapon.mainhand battle:item/gun_hammer/ammo
# - 弾数が0だったら棒に変える
execute if score ammo _ matches 0 run loot replace entity @s weapon.mainhand loot battle:item/gun_hammer/gun_0
