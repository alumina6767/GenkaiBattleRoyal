...
summon armor_stand ~ ~0.5 ~ {Tags:["HammerModel"],Silent:1b,Invulnerable:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:1}}],Pose:{Head:[0f,0f,0f]}}
