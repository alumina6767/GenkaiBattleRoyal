...
summon armor_stand ~ ~0.5 ~ {Tags:["HammerModel"],Silent:1b,Invulnerable:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{CustomModelData:670142}}],Pose:{Head:[90f,0f,0f]}}
