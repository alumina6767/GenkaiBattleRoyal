...
## 計算用マーカー
execute facing entity @a[tag=target] eyes positioned 0.0 0.0 0.0 run summon marker ^ ^0.02 ^0.8 {UUID:[I;6,7,0,7]}

## 飛ばす
data modify entity @e[type=llama_spit,tag=new,limit=1] Motion set from entity 00000006-0000-0007-0000-000000000007 Pos

## 毒
execute as @s[tag=!level2] run tag @e[type=llama_spit,tag=new,limit=1] add tarako.tuba.poison
