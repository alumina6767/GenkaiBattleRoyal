...
## インジゲータの設置
execute at @s rotated ~ 0 run summon armor_stand ^ ^1.5 ^-0.5 {Small:1b,Marker:1b,CustomName:'{"text": ""}',CustomNameVisible:1b,Invisible:1b,Tags:["new","battle.damage_indicator"],Silent:1b}
